    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                target_feature_train_df = pd.to_numeric(
                    target_feature_train_df,
                    errors="raise"
                ).astype(int)

                logging.info(f"Training target dtype: {target_feature_train_df.dtype}")
                logging.info(f"Training target unique values: {target_feature_train_df.unique()}")
                # ================================================
                ...
                target_feature_test_df = pd.to_numeric(
                    target_feature_test_df,
                    errors="raise"
                ).astype(int)

                logging.info(f"Testing target dtype: {target_feature_test_df.dtype}")
                logging.info(f"Testing target unique values: {target_feature_test_df.unique()}")
                # ================================================
                ...
                logging.info(f"Target type: {type_of_target(target_feature_train_df)}")
                logging.info(target_feature_train_df.value_counts())
